...
####################################################################################################
    def __init__(
        ...
        self.missing_notes_written = {float(m) for m in missing_notes}
        ...
        self.physicalDynamicRangedB = tuple(float(x) for x in physicalDynamicRangedB)
    ...
    def __repr__(self):
        return (
            f"Instrument(name={self.name!r}, "
            f"rangeMidi={self.rangeMidi}, "
            f"numSystems={self.numSystems}, "
            f"initClefs={self.initClefs}, "
            f"possibleClefs={self.possibleClefs}, "
            f"chordsPossible={self.chordsPossible}, "
            f"microTones={self.microTones}, "
            f"writtenDynamicRange={self.writtenDynamicRange}, "
            f"physicalDynamicRangedB={self.physicalDynamicRangedB}, "
            f"transposition_semitones={self.transposition_semitones}, "
            f"missing_notes(written)={self.missing_notes_written}, "
            f"midi_program={self.midi_program})"
        )